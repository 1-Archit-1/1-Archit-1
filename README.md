...
**Day to day:** Python, R, SQL (Postgres, SQL Server), FastAPI, Azure, Docker

**Also in the toolkit:** C#, C, PHP, Java, Django, React, MongoDB, Redis, AWS, Laravel, GitHub Actions, Nginx
...
Running a self-hosted media server on Docker at home. Trying to make Linux gaming not a full-time job. Playing football when I can.

---

[LinkedIn](https://linkedin.com/in/architsengupta) · [architsengupta@gmail.com](mailto:architsengupta@gmail.com)
